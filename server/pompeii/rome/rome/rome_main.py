...
def apply_rome_to_model(
    ...
    logging.info(f"New weights successfully inserted into {list(deltas.keys())}")
...
def execute_rome(
    ...
    logging.info(f"Deltas successfully computed for {list(weights.keys())}")
...
def get_context_templates(model, tok):
    ...
    if CONTEXT_TEMPLATES_CACHE is None:
        ...
        logging.info(f"Cached context templates {CONTEXT_TEMPLATES_CACHE}")
